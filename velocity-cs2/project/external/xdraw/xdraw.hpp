...
namespace tokens {
	...
	// neverlose-inspired palette: near-black surfaces, white accent
	inline xdraw::color col_accent{ 235, 235, 235, 255 };
	inline xdraw::color col_dark{ 8, 8, 8, 255 };
	inline xdraw::color col_text{ 255, 255, 255, 240 };
	inline xdraw::color col_text_dim{ 130, 133, 143, 255 };
	inline xdraw::color col_card{ 8, 8, 8, 215 };
	inline xdraw::color col_elevated{ 31, 31, 31, 235 };

	// wide, neverlose-style sidebar
	constexpr auto sidebar_w{ 170.0f };
	constexpr auto tab_icon_size{ 18.0f };
	constexpr auto tab_row_h{ 28.0f };
	constexpr auto subtab_bar_h{ 35.0f };
	constexpr auto gap{ 8.0f };
	constexpr auto card_rounding{ 6.0f };
