...
namespace xui {
	...
	struct style
	{
		...
		xdraw::color window_bg{ 14, 14, 14, 235 };
		xdraw::color window_border{ 255, 255, 255, 12 };

		xdraw::color child_bg{ 8, 8, 8, 215 };
		xdraw::color child_border{ 255, 255, 255, 12 };

		xdraw::color checkbox_bg{ 13, 13, 13, 255 };
		xdraw::color checkbox_border{ 255, 255, 255, 16 };
		xdraw::color checkbox_mark{ 235, 235, 235, 255 };
		xdraw::color checkbox_mark_icon{ 10, 10, 10, 255 };

		xdraw::color slider_track{ 13, 13, 13, 255 };
		xdraw::color slider_fill{ 235, 235, 235, 255 };

		xdraw::color button_bg{ 13, 13, 13, 255 };
		xdraw::color button_border{ 255, 255, 255, 12 };
		xdraw::color button_hovered{ 26, 26, 26, 255 };
		xdraw::color button_active{ 235, 235, 235, 255 };

		xdraw::color keybind_bg{ 13, 13, 13, 255 };
		xdraw::color keybind_border{ 255, 255, 255, 12 };
		xdraw::color keybind_waiting{ 235, 235, 235, 255 };

		xdraw::color combo_bg{ 13, 13, 13, 255 };
		xdraw::color combo_border{ 255, 255, 255, 12 };
		xdraw::color combo_arrow{ 255, 255, 255, 130 };
		xdraw::color combo_hovered{ 26, 26, 26, 255 };
		xdraw::color combo_popup_bg{ 14, 14, 14, 245 };
		xdraw::color combo_popup_border{ 255, 255, 255, 12 };
		xdraw::color combo_popup_item_hovered{ 31, 31, 31, 255 };
		xdraw::color combo_popup_item_selected{ 235, 235, 235, 36 };

		xdraw::color popup_bg{ 14, 14, 14, 245 };
		xdraw::color popup_border{ 255, 255, 255, 12 };

		xdraw::color picker_bg{ 13, 13, 13, 255 };
		xdraw::color picker_border{ 255, 255, 255, 12 };
		xdraw::color picker_popup_bg{ 14, 14, 14, 245 };
		xdraw::color picker_popup_border{ 255, 255, 255, 12 };

		xdraw::color text_input_bg{ 13, 13, 13, 255 };
		xdraw::color text_input_border{ 255, 255, 255, 12 };

		xdraw::color separator{ 255, 255, 255, 22 };

		xdraw::color text{ 255, 255, 255, 240 };
		xdraw::color text_dim{ 130, 133, 143, 255 };
		xdraw::color accent{ 235, 235, 235, 255 };
	};
